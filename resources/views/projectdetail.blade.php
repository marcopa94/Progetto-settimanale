...
@section('titolo', 'qua puoi modificare E IN BASSO AGGIUNGERE TASK CON DIVERSE PRIORITA!')
@section('paragrafo', '')
@section ('content')
<x-app-layout>
    <x-slot name="header">
        <div class=" d-flex justify-content-between">
            ...
            <div class=" d-flex justify-content-between gap-3">
                <a href="/projects/{{$project->id}}/edit" class="btn btn-success rounded-5">MODIFICA</a>
